...
<body>
	...
	<div class="bg-image"
		...
		<center>
			...
			<h3 class="text-dark fs-1" style="display: inline-block;">Truck
				Driver Home</h3>
					...
					<tbody>
						<c:forEach items="${sd}" var="sd">
							<tr>
								...
								<td>${sd.suppName}</td>
								<td><a
									href="https://www.google.com/maps/place/${sd.fromAddress}">${sd.fromAddress}</a></td>
								<td>${sd.suppContactDetails}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>

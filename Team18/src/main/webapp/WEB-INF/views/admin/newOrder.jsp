		...
		<div class="container-fluid">
			<div class="container-fluid">
				<a class="navbar-brand" href="/admin/adminHome"> <img
					...
					class="d-inline-block align-items-center " style="font: size 10px;">
					<h3 style="font-size: 25px; color: white; display: inline-block;">Dart
...
<!-- Form for new order  -->
										<form class="mx-1 mx-md-4">
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<div class="form-outline flex-fill mb-0">
													<label class="form-label" for="form3Example4c">Phone
												...
												<div class="form-outline flex-fill mb-0">
													<label class="form-label" for="form3Example4c">Choose
														...
														<c:forEach items="${TruckDetails}" var="TruckDetails">
															...
															<option value="${TruckDetails.truckId }">
																${TruckDetails.driverName}</option>
														</c:forEach>
													</select>
												...
												<div class="form-outline flex-fill mb-0">
													...
													<div
														...
														<button class="btn btn-lg btn-primary btn-block"
															name="AssignOrder" value="AssignOrder" type="Submit"
															text="AssignOrder">Assign Order</button>
													</div>

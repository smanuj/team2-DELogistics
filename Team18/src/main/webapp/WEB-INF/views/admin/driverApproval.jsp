...
<title>Pending Driver Approvals -- ADMIN</title>
...
<div class="position-absolute top-0 start-50 translate-middle-x">
	<h1 class="text-white">Dart Express Logistics</h1>
</div>

...
<title>Supplier Details -- ADMIN</title>
...
<body>
	<div class="bg-image"
		...
		<!-- Table to display supplier details -->
			...
			<tbody>
				<c:forEach items="${SupplierDetails}" var="SupplierDetails">
					<tr>
						...
						<td><a href="https://www.google.com/maps/place/${SupplierDetails.fromAddress}">${SupplierDetails.fromAddress}</a></td>

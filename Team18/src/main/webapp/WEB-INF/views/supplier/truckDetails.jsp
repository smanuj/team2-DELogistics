...
<title>Truck Details -- SUPPLIER</title>
...
<body>
	<div class="bg-image"
		style="background-image: url('https://images.pexels.com/photos/1797428/pexels-photo-1797428.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1600'); height: 87vh; background-size: cover;">
		...
		<center>
			...
			<h3 class="text-dark fs-1"
				style="display: inline-block;">Truck
				Details</h3>
</center>
...
<footer>
    <div class="text-align-right p-3 text-white" style="background-color: black;">
       2020 Copyright:
      <a class="text-white" href="/aboutUs">delogistics.com</a>
    </div>
  </footer>

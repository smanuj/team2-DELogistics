...
<div class="container-fluid">
	<div class="container-fluid">
		<a class="navbar-brand" href="/supplier/supplierHome/${id}"> <img
			...
			class="d-inline-block align-text-center fs-1"
	...
	<li class="nav-item"><a
		class="nav-link active d-inline-block align-top fs-1 text-white "
	...
	<li class="nav-item"><a
		class="nav-link active d-inline-block align-top fs-1 text-white "
		aria-current="page" href="/supplier/supplierLogin">Logout</a></li>
</div>
</div>

	...
	<div class="container-fluid">
		<div class="container-fluid">
			<a class="navbar-brand" href="/supplier/supplierHome/${id}"> <img
				...
				<h3 
					style="font-size: 35px; color: white; display: inline-block;">
...
<body>
	...
	<div class="bg-image"
		...
		<table class="table table-hover table-sm table-secondary table-bordered table-striped">
			...
			<tbody>
				<c:forEach items="${ OrderDetails}" var="OrderDetails">
					<tr>
						...
						<td><a
							href="https://www.google.com/maps/place/${OrderDetails.toAddress}"><button class="btn btn-sm btn-md btn-warning">

...
<div class="sticky-top">
	...
	<div class="container-fluid">
		<div class="container-fluid">
			<a class="navbar-brand" href="/supplier/supplierHome/${id}"> <img
...
<body>
	...
	<div class="bg-image"
		style="background-image: url('https://images.pexels.com/photos/1797428/pexels-photo-1797428.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1600'); height: 100vh; background-size: cover;">
		...
		<center>
			...
			<h3 class="text-dark fs-1" style="display: inline-block;">Order
				Details</h3>
		...
		<div class="row">
			<div class="table-responsive col-md-7">
				<table
					class="table table-hover table-sm table-secondary table-bordered table-striped">
					...
					<tbody>
						<c:forEach items="${ OrderDetails}" var="OrderDetails">
							<tr>
								...
								<td><a
									href="https://www.google.com/maps/place/${OrderDetails.toAddress}"><button
											class="btn btn-sm btn-md btn-warning">
											<i class="fa fa-location-arrow"></i>${OrderDetails.toAddress}</a></td>
			...
			<div class="table-responsive col-md-5">
				<table
					class="table table-hover table-sm table-secondary table-striped">
					<thead class="thead-dark">
						<tr>
							<!-- <td>Order Id</td> -->
							<td>Truck Id</td>
					...
					<tbody>
						<c:forEach items="${td}" var="td">
							<tr>
								...
								<td>${td.temp}<button type="button"
										class="btn btn-secondary" data-toggle="tooltip"
										data-placement="top"
										title="Optimum temperature for Food items is 14 C , Medicines/Icecreams is -4C  ">
								...
								<td><a
									href="https://www.google.com/maps/place/Valtech/@12.9164417,77.5968254,17z/data=!3m1!4b1!4m5!3m4!1s0x3bae150e413b549d:0x24ddb1c1c2c81592!8m2!3d12.9164365!4d77.5990141">
										<button class="btn btn-sm btn-md btn-warning"
											data-toggle="tooltip" data-placement="top"
											title="Click here to view the live location ">
